...
//     Object.keys(docNav).forEach(key => {
//         let subtopics = get(docNav, [key, "subTopics"])
//         Object.keys(subtopics).forEach(subtopic => {
//             let file = get(docNav, [key, "subTopics", subtopic, "file"])
//             let headerName = get(docNav, [key, "subTopics", subtopic, "headerName"])
//             let section = require(`../content/docs/${file}.md`)
...
//             let index = new Promise((resolve) => resolve(CreateIndex()))
