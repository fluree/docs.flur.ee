...
Our [Github repo](https://github.com/fluree/supply-chain/blob/096/Additional-POs-Pt1.js) for this example has additional transaction and queries that you can test against this database.
