export const docNav091 = {
    "getting-started": {
        "subTopics": {
            "intro": {
                "headerName": "Intro",
                "file": "0.9.1/docs/start/intro"
            },
            "quickstart": {
                "headerName": "Quickstart",
                "file": "0.9.1/docs/start/quickstart"
            }
        },
    ...
    "query": {
        "subTopics": {
            "query": {
                "headerName": "Query",
                "file": "0.9.1/docs/query/query"
            },
            "graphql": {
                "headerName": "GraphQL",
                "file": "0.9.1/docs/query/graphql"
            }
        },
        "pageName": "Query"
    },
    ...
    "transact": {
        "subTopics": {
            "transact": {
                "headerName": "Transact",
                "file": "0.9.1/docs/transact/transact"
            }
        },
        "pageName": "Transact"
    },
    "permissions": {
        "subTopics": {
            "functions": {
                ...
                "file": "0.9.1/docs/permissions/functions"
            },
            "permissions": {
                "headerName": "Permissions",
                "file": "0.9.1/docs/permissions/permissions"
            }
        },
    ...
    "examples": {
        "subTopics": {
            "cryptocurrency": {
                ...
                "file": "0.9.1/docs/examples/cryptocurrency"
            },
            "rule-governance": {
                "headerName": "Rule Governance",
                "file": "0.9.1/docs/examples/ruleGovernance"
            }
        },
        "pageName": "Examples"
    }
    ...
    "getting-started": {
        "subTopics": {
            ...
            "installation": {
                ...
                "file": "0.9.5/docs/start/installation"
            },
            "user-interface": {
    ...
    "query": {
        ...
        "subTopics": {
            "overview": {
                ...
                "file": "0.9.5/docs/query/basic-query"
            },
            "block-query": {
                "headerName": "Block Query",
                "file": "0.9.5/docs/query/block-query"
            },
            "history-query": {
                "headerName": "History Query",
                "file": "0.9.5/docs/query/history-query"
            },
            "advanced-query": {
                "headerName": "Advanced Query",
                "file": "0.9.5/docs/query/advanced-query"
            },
            "analytical-query": {
                "headerName": "Analytical Query",
                "file": "0.9.5/docs/query/analytical-query"
            },
            "sparql": {
                "headerName": "SPARQL",
                "file": "0.9.5/docs/query/sparql"
            },
            "graphql": {
                "headerName": "GraphQL",
                "file": "0.9.5/docs/query/graphql"
            }
        }
    ...
    "transact": {
        ...
        "subTopics": {
            "basics": {
                ...
                "file": "0.9.5/docs/transact/basics"
            },
            "adding-data": {
                "headerName": "Adding Data",
                "file": "0.9.5/docs/transact/adding-data"
            },
            "updating-data": {
                "headerName": "Updating Data",
                "file": "0.9.5/docs/transact/updating-data"
            },
            "deleting-data": {
                "headerName": "Deleting Data",
                "file": "0.9.5/docs/transact/deleting-data"
            }
        }
    },
    "smart-functions": {
        ...
        "subTopics": {
            "smart-functions": {
                "headerName": "Intro",
                "file": "0.9.5/docs/smart-functions/intro"
            },
            "predicate-spec": {
            ...
            "collection-spec": {
                ...
                "file": "0.9.5/docs/smart-functions/collection-spec"
            },
            "predicate-tx-spec": {
            ...
            "rule-example": {
                ...
                "file": "0.9.5/docs/smart-functions/rule-example"
            },
            "fns-in-txs": {
    ...
    "identity": {
        ...
        "subTopics": {
            "public-private-keys": {
                ...
                "file": "0.9.5/docs/identity/public-private-keys"
            },
            "auth-records": {
                "headerName": "Auth Records",
                "file": "0.9.5/docs/identity/auth-records"
            },
            "signatures": {
                "headerName": "Signatures",
                "file": "0.9.5/docs/identity/signatures"
            }
        }
    },
    "schema": {
        ...
        "subTopics": {
            "overview": {
                "headerName": "Overview",
                "file": "0.9.5/docs/schema/overview"
            },
            "collections": {
                "headerName": "Collections",
                "file": "0.9.5/docs/schema/collections"
            },
            "predicates": {
                "headerName": "Predicates",
                "file": "0.9.5/docs/schema/predicates"
            }
        }
    },
    "database-setup": {
        ...
        "subTopics": {
            "creating-a-db": {
                ...
                "file": "0.9.5/docs/db-setup/creating-a-database"
            },
            "database-settings": {
                "headerName": "Database Settings",
                "file": "0.9.5/docs/db-setup/database-settings"
            },
            "forking-a-db": {
                "headerName": "Forking a DB",
                "file": "0.9.5/docs/db-setup/forking-a-database"
            },
            "deleting-a-database": {
                "headerName": "Deleting a DB",
                "file": "0.9.5/docs/db-setup/deleting-a-database"
            }
        }
    },
    "infrastructure": {
        ...
        "subTopics": {
            "db-infrastructure": {
                ...
                "file": "0.9.5/docs/infrastructure/db_infrastructure"
            },
            "network-infrastructure": {
                "headerName": "Network Infrastructure",
                "file": "0.9.5/docs/infrastructure/network_infrastructure"
            },
            "system-collections": {
                "headerName": "System Collections",
                "file": "0.9.5/docs/infrastructure/system_collections"
            },
            "application-best-practices": {
                "headerName": "Best Practices",
                "file": "0.9.5/docs/infrastructure/app_best_practices"
            }
        }
    },
    "examples": {
        ...
        "subTopics": {
            "cryptocurrency": {
                "headerName": "Cryptocurrency",
                "file": "0.9.5/docs/examples/cryptocurrency"
            },
            "voting": {
                "headerName": "Voting",
                "file": "0.9.5/docs/examples/voting"
            },
            "supply-chain": {
                "headerName": "Supply Chain",
                "file": "0.9.5/docs/examples/supply-chain"
            },
        }
    }
}
