...
- [Universal Functions](/overview/schema/smartfunctions.md#universal-functions)
- [Context Dependent Functions](/overview/schema/smartfunctions.md#context-dependent-functions)
