...
[Fluree Anywhere](../../reference/http/examples#-new-db) or through
...
Every collection has [predicates](../overview/schema/predicates.md). Predicates are analogous
...
(read more about the [subject-predicate-object model](../concepts/what-is-fluree#subject-predicate-object-model)).
...
predicates can be found in the [Predicates](../overview/schema/predicates.md) section. For
