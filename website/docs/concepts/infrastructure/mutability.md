...
There is the standard way of [deleting data](../../overview/transact/deleting_data). Using
...
endpoint ([see example](../../reference/http/examples#-history)).
...
To see an example of `hide` request, see the [API section on /hide](../../reference/http/examples#-hide).
...
ledgers (see the [query syntax](../../overview/query/analytical_query#prefixes-key) here).
