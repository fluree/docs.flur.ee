...
## _Transactor Group Options {#transactor-group-options}
...
## _HTTP API Settings {#http-api-settings}
...
## _Decentralized Ledger Settings {#decentralized-ledger-settings}
...
## _Password and JWT Token Settings {#password-and-jwt-token-settings}
